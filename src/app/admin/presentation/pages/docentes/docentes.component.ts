                ...
                <tr class="hover:bg-slate-50/30 transition duration-150">
                  <td class="px-6 py-4">
                    <div class="flex items-center gap-3">
                      @if (d.fotoUrl) {
                        <img [src]="d.fotoUrl" (click)="fotoAmpliada.set(d.fotoUrl)" alt="Avatar" class="w-8 h-8 rounded-full object-cover shrink-0 border border-slate-100 shadow-sm cursor-zoom-in hover:scale-110 active:scale-95 transition-all duration-200" />
                      } @else {
